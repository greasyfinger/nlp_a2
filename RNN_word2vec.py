...
train_tokens = load_data("task_1_fin/token_dataset/train_set.json", "tokens")
train_labels = load_data("task_1_fin/label_dataset/train_set.json", "labels")

val_tokens = load_data("task_1_fin/token_dataset/val_set.json", "tokens")
val_labels = load_data("task_1_fin/label_dataset/val_set.json", "labels")
...
print("Running RNN")
model = RNNModel(
    embedding_dim=300, hidden_dim=256, num_layers=1, num_classes=num_labels
).to(device)

criterion = nn.CrossEntropyLoss()
optimizer = torch.optim.Adam(model.parameters(), lr=1e-5)

run_epoch("RNN_word2vec", model)
