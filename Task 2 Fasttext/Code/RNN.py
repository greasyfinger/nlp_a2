...
plt.ylabel('Loss')
plt.legend()
plt.savefig('/home/nalin21478/nlp_a2/Task 2 Fasttext/Plots/loss_plot_RNN_glove.png')  # Save the plot as an image
plt.show()
...
plt.ylabel('F1 Score')
plt.legend()
plt.savefig('/home/nalin21478/nlp_a2/Task 2 Fasttext/Plots/f1_score_plot_RNN_glove.png')  # Save the plot as an image
plt.show()
...
with open('/home/nalin21478/nlp_a2/Task 2 Fasttext/History/history_RNN_glove.json', 'w') as f:
    json.dump(history.history, f)

import pickle
with open("/home/nalin21478/nlp_a2/Task 2 Fasttext/Models/t2_RNN_Glove.pkl", "wb") as file:
