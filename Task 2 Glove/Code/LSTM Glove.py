...
# %%
embedding_dim = 300  # Adjust the dimension according to the GloVe embedding file you're using

glove_model_path = '/home/nalin21478/nlp_a2/Task 2 Glove/Glove/glove.6B.300d.txt'
...
history = model.fit(train_sequences_padded, y_train, epochs=50, batch_size=64, 
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('/home/nalin21478/nlp_a2/Task 2 Glove/Plots/loss_plot_LSTM_glove.png')  # Save the plot as an image
plt.show()
...
plt.ylabel('F1 Score')
plt.legend()
plt.savefig('/home/nalin21478/nlp_a2/Task 2 Glove/Plots/f1_score_plot_LSTM_glove.png')  # Save the plot as an image
plt.show()
...
with open('/home/nalin21478/nlp_a2/Task 2 Glove/History/history_LSTM_glove.json', 'w') as f:
    json.dump(history.history, f)

import pickle
with open("/home/nalin21478/nlp_a2/Task 2 Glove/Models/t2_LSTM_Glove.pkl", "wb") as file:
