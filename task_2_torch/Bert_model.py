...
print("RUNNING ON BERT EMBEDDINGS")
model_name = "bert-base-uncased"

tokenizer = BertTokenizer.from_pretrained(model_name)
embeddings = BertModel.from_pretrained(model_name).embeddings
...
# run_epochs(model, tokenizer, "RNN-Bert_2")
...
run_epochs(model, tokenizer, "LSTM-Bert_2")
...
run_epochs(model, tokenizer, "GRU-Bert_2")
